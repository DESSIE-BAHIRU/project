...
public class GroupDelete {
    ...
    public TextField tfDeletpackage delete;
...
public class GroupDelete {
    ...
    public void groupDelete() {
        ...
        btnSearch.setOnAction(value -> {
            try {
                text[0] = searchEvent.search(tfSearch.getText(), "GroupRegister.txt");
        ...
        btnDelete.setOnAction(value -> {
            try {
                deleteEvent.delete(text[0], tfSearch.getText(), stage, "GroupRegister.txt");
            } catch (IOException ioException) {
            }
        });
